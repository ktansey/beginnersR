...
setwd("c:/")
```   
Choose the appropriate one for your computer and **DELETE** the other one. Use tab completion to move to the  BeginnersR_Materials_Day1 folder on your computer.      
